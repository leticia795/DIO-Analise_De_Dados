...
CREATE TABLE IF NOT EXISTS `mydb`.`Veiculos` (
  ...
  `Cliente_idCliente` INT NOT NULL,
  PRIMARY KEY (`idVeiculos`, `Cliente_idCliente`),
  INDEX `fk_Veiculos_Cliente1_idx` (`Cliente_idCliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Ordem_de_Servico` (
  ...
  `Status` ENUM('Aberto', 'Em Andamento', 'Concluído') NOT NULL,
  `Valor_Total` VARCHAR(45) NOT NULL,
  `Veiculos_idVeiculos` INT NOT NULL,
  `Quantidade` INT NOT NULL,
  PRIMARY KEY (`idOS`, `Veiculos_idVeiculos`),
  INDEX `fk_Ordem_de_Servico_Veiculos1_idx` (`Veiculos_idVeiculos` ASC) VISIBLE,
  CONSTRAINT `fk_Ordem_de_Servico_Veiculos1`
...
-- -----------------------------------------------------
-- Table `mydb`.`OS_Mecânicos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`OS_Mecânicos` (
  `Ordem_de_Servico_idOS` INT NOT NULL,
  `Ordem_de_Servico_Cliente_idCliente` INT NOT NULL,
  `Mecânicos_idMecânicos` INT NOT NULL,
  PRIMARY KEY (`Ordem_de_Servico_idOS`, `Ordem_de_Servico_Cliente_idCliente`, `Mecânicos_idMecânicos`),
  INDEX `fk_Ordem_de_Servico_has_Mecânicos_Mecânicos1_idx` (`Mecânicos_idMecânicos` ASC) VISIBLE,
  INDEX `fk_Ordem_de_Servico_has_Mecânicos_Ordem_de_Servico1_idx` (`Ordem_de_Servico_idOS` ASC, `Ordem_de_Servico_Cliente_idCliente` ASC) VISIBLE,
  CONSTRAINT `fk_Ordem_de_Servico_has_Mecânicos_Ordem_de_Servico1`
    FOREIGN KEY (`Ordem_de_Servico_idOS`)
    REFERENCES `mydb`.`Ordem_de_Servico` (`idOS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Ordem_de_Servico_has_Mecânicos_Mecânicos1`
...
-- Table `mydb`.`Peças_OS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Peças_OS` (
  `Peças_idPeças` INT NOT NULL,
  `Ordem_de_Servico_idOS` INT NOT NULL,
  `Ordem_de_Servico_Cliente_idCliente` INT NOT NULL,
  PRIMARY KEY (`Peças_idPeças`, `Ordem_de_Servico_idOS`, `Ordem_de_Servico_Cliente_idCliente`),
  INDEX `fk_Peças_has_Ordem_de_Servico_Ordem_de_Servico1_idx` (`Ordem_de_Servico_idOS` ASC, `Ordem_de_Servico_Cliente_idCliente` ASC) VISIBLE,
  INDEX `fk_Peças_has_Ordem_de_Servico_Peças1_idx` (`Peças_idPeças` ASC) VISIBLE,
  CONSTRAINT `fk_Peças_has_Ordem_de_Servico_Peças1`
    FOREIGN KEY (`Peças_idPeças`)
    REFERENCES `mydb`.`Pecas` (`idPeças`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Peças_has_Ordem_de_Servico_Ordem_de_Servico1`
    FOREIGN KEY (`Ordem_de_Servico_idOS`)
    REFERENCES `mydb`.`Ordem_de_Servico` (`idOS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`Serviço_has_Ordem_de_Servico`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Serviço_has_Ordem_de_Servico` (
  `Serviço_idServiço` INT NOT NULL,
  `Ordem_de_Servico_idOS` INT NOT NULL,
  `Ordem_de_Servico_Cliente_idCliente` INT NOT NULL,
  PRIMARY KEY (`Serviço_idServiço`, `Ordem_de_Servico_idOS`, `Ordem_de_Servico_Cliente_idCliente`),
  INDEX `fk_Serviço_has_Ordem_de_Servico_Ordem_de_Servico1_idx` (`Ordem_de_Servico_idOS` ASC, `Ordem_de_Servico_Cliente_idCliente` ASC) VISIBLE,
  INDEX `fk_Serviço_has_Ordem_de_Servico_Serviço1_idx` (`Serviço_idServiço` ASC) VISIBLE,
  CONSTRAINT `fk_Serviço_has_Ordem_de_Servico_Serviço1`
    FOREIGN KEY (`Serviço_idServiço`)
    REFERENCES `mydb`.`Serviço` (`idServiço`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Serviço_has_Ordem_de_Servico_Ordem_de_Servico1`
    FOREIGN KEY (`Ordem_de_Servico_idOS`)
    REFERENCES `mydb`.`Ordem_de_Servico` (`idOS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
